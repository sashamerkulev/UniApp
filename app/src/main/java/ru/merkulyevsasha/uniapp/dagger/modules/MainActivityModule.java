...
import ru.merkulyevsasha.uniapp.dagger.components.AccommodationComponent;
...
@Module(subcomponents = {AccommodationComponent.class, LibraryComponent.class, MusicComponent.class,
...
abstract class MainActivityModule {
    ...
    @AccommodationScope
    @ContributesAndroidInjector(modules = {AccommodationModule.class})
    abstract AccommodationFragment injectorAccomodationFragment();
